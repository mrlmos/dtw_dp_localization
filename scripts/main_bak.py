...
from pd_location.experiment_loader import Experiment, load_experiments, get_experiment
from pd_location.dtw import gen_cost_matrix, backtracking, plot_dtw
...
def batch_estimation(
    ...
    for exp in experiments:
        ...
        for i in range(len(voltages)):
            if i == ref_index:
                continue
            D = gen_cost_matrix(v_ref, voltages[i], distance, radius=r)
...
sheet_path = "/home/murilo/dev/python/tcc/dtw/result_sheets/"
df = batch_estimation(experimentos, cum_energy_exp)
exel_export(df, sheet_path, "cum_energy.xlsx")
